...
import { useForm , Controller, FieldError, Control,UseFormRegister, Path} from "react-hook-form";
...
function FormInputText({ errors, name, control, label, register}: AppProps) {
    ...
    return (
        <FormControl fullWidth margin="dense" size="small">
            <InputLabel htmlFor="bootstrap-input"  shrink={true}  error={errors && name in errors}>
                  {label}
            </InputLabel>
            <Controller
                name={name}
